...
BUTTON_TYPES = {
    ...
    add(btn_add_city, btn_add_product, btn_add_district).add(btn_del_city, btn_del_product, btn_del_district).add(btn_t).add(btn_malling, btn_malling_del, btn_malling_all).add(btn_all_info).add(btn_t).
